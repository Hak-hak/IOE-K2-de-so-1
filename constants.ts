...
export const QUIZ_DATA: Question[] = [
  ...
  // --- PART 9: SENTENCE ARRANGEMENT (81-90) ---
  { id: 81, type: QuestionType.REARRANGE, questionText: "Sắp xếp câu:", rearrangeParts: ["is", "What", "this?"], correctAnswer: "What is this?", explanation: "Đây là cái gì?" },
  { id: 82, type: QuestionType.REARRANGE, questionText: "Sắp xếp câu:", rearrangeParts: ["a", "It", "pen.", "is"], correctAnswer: "It is a pen.", explanation: "Nó là một cái bút." },
  { id: 83, type: QuestionType.REARRANGE, questionText: "Sắp xếp câu:", rearrangeParts: ["a", "Is", "it", "cat?"], correctAnswer: "Is it a cat?", explanation: "Nó có phải là con mèo không?" },
  { id: 84, type: QuestionType.REARRANGE, questionText: "Sắp xếp câu:", rearrangeParts: ["it", "Yes,", "is."], correctAnswer: "Yes, it is.", explanation: "Vâng, đúng vậy." },
  { id: 85, type: QuestionType.REARRANGE, questionText: "Sắp xếp câu:", rearrangeParts: ["isn't.", "No,", "it"], correctAnswer: "No, it isn't.", explanation: "Không, không phải." },
  { id: 86, type: QuestionType.REARRANGE, questionText: "Sắp xếp câu:", rearrangeParts: ["like", "dogs.", "I"], correctAnswer: "I like dogs.", explanation: "Tôi thích chó." },
  { id: 87, type: QuestionType.REARRANGE, questionText: "Sắp xếp câu:", rearrangeParts: ["have", "I", "ball.", "a"], correctAnswer: "I have a ball.", explanation: "Tôi có một quả bóng." },
  { id: 88, type: QuestionType.REARRANGE, questionText: "Sắp xếp câu:", rearrangeParts: ["nose.", "Touch", "your"], correctAnswer: "Touch your nose.", explanation: "Chạm vào mũi của bạn." },
  { id: 89, type: QuestionType.REARRANGE, questionText: "Sắp xếp câu:", rearrangeParts: ["your", "Open", "book."], correctAnswer: "Open your book.", explanation: "Mở sách ra." },
  { id: 90, type: QuestionType.REARRANGE, questionText: "Sắp xếp câu:", rearrangeParts: ["up.", "Stand"], correctAnswer: "Stand up.", explanation: "Đứng dậy." },

  // --- PART 10: MIXED REVIEW (91-100) ---
  { id: 91, type: QuestionType.MULTIPLE_CHOICE, questionText: "Choose the odd one out (Chọn từ khác loại):", options: ["Red", "Blue", "Cat", "Green"], correctAnswer: "Cat", explanation: "Cat là con vật, còn lại là màu sắc." },
  { id: 92, type: QuestionType.MULTIPLE_CHOICE, questionText: "Choose the odd one out:", options: ["One", "Two", "Ten", "Ball"], correctAnswer: "Ball", explanation: "Ball là đồ chơi, còn lại là số đếm." },
  { id: 93, type: QuestionType.FILL_IN_BLANK, questionText: "Sch_ol", correctAnswer: "o", explanation: "School: Trường học." },
  { id: 94, type: QuestionType.FILL_IN_BLANK, questionText: "Fri_nd", correctAnswer: "e", explanation: "Friend: Bạn bè." },
  { id: 95, type: QuestionType.MULTIPLE_CHOICE, questionText: "One + One = ___.", options: ["Two", "Three", "Four", "Five"], correctAnswer: "Two", explanation: "1 + 1 = 2 (Two)." },
  { id: 96, type: QuestionType.FILL_IN_BLANK, questionText: "Hap_y", correctAnswer: "p", explanation: "Happy: Vui vẻ." },
  { id: 97, type: QuestionType.MULTIPLE_CHOICE, questionText: "Apple is ___.", options: ["red", "blue", "black", "white"], correctAnswer: "red", explanation: "Red: Quả táo thường màu đỏ." },
  { id: 98, type: QuestionType.FILL_IN_BLANK, questionText: "S_d", correctAnswer: "a", explanation: "Sad: Buồn bã." },
  { id: 99, type: QuestionType.FILL_IN_BLANK, questionText: "Tha_k you.", correctAnswer: "n", explanation: "Thank you: Cảm ơn." },
  { id: 100, type: QuestionType.REARRANGE, questionText: "Sắp xếp câu:", rearrangeParts: ["soon.", "See", "you"], correctAnswer: "See you soon.", explanation: "Hẹn gặp lại sớm." }
];